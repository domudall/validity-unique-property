...
describe('Unique property validator', function () {
  ...
  describe('find()', function () {
    it('should provide an error message if find() returns a result', function (done) {
      var validate = createValidator(function (query, cb) {
        return cb(null, [ { _id: 'aaaa', username: 'jim' } ])
      })
      validate('username', 'user name', { username: 'jim' }, function (err, errMessage) {
    ...
    it('should not provide an error message if find() does not have a result', function (done) {
      var validate = createValidator(function (query, cb) {
        return cb(null, [])
      })
      validate('username', 'user name', { username: 'jim' }, function (err, errMessage) {
    ...
    it('should not provide an error message if find() returns a result that has the same id', function (done) {
      var validate = createValidator(function (query, cb) {
        return cb(null, [ { _id: 'aaaa', username: 'jim' } ])
      })
      validate('username', 'user name', { _id: 'aaaa', username: 'jim' }, function (err, errMessage) {
    ...
    it('should provide an error message if find() returns a result that has a different id', function (done) {
      var validate = createValidator(function (query, cb) {
        return cb(null, [ { _id: 'bbbb', username: 'jim' } ])
      })
      validate('username', 'user name', { _id: 'aaaa', username: 'jim' }, function (err, errMessage) {
    ...
    it('should provide an error message if find() returns multiple entities', function (done) {
      var validate = createValidator(function (query, cb) {
        return cb(null, [ { _id: 'aaaa', username: 'jim' }, { _id: 'bbbb', username: 'jim' } ])
      })
      validate('username', 'user name', { username: 'jim' }, function (err, errMessage) {
        if (err) return done(err)
        assert.equal('"jim" already in use', errMessage)
    ...
    it('should not provide an error message if find() does not have a result for multi-properties', function (done) {
      var validate = createValidator(function (query, cb) {
        return cb(null, [])
      })
      validate(['username', 'email'], 'user name', { username: 'jim', email: 'test@test.com' }, function (err, errMessage) {
    ...
    it('should provide an error message if find() returns a result for multi-properties', function (done) {
      var validate = createValidator(function (query, cb) {
        assert.deepEqual(query, { username: 'jim', _ident: 'aaaa' })
        return cb(null, [ { _ident: 'aaaa', username: 'jim' } ])
      }, { idProperty: '_ident' })
